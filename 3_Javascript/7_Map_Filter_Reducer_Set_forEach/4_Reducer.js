...
const just_add = products.reduce((accumulator , currentValue) => {
    return accumulator + currentValue.price;
},0);
console.log(just_add);


const check_inStock = products.reduce((accumulator , currentValue) => {
